...
class ModelMetricsNBA(object):
    ...
    def get_metrics(self, tableau_input_filename, matchup_output_us, cs_team_stats_filename):
        ...
        df = pandas.pandas.read_csv(tableau_input_filename)
        ...
        current_date_type_datetime = pandas.to_datetime(current_date, format="%m/%d/%Y")
        ...
        cs_team_stats_df = pandas.pandas.read_csv(cs_team_stats_filename)
        ...
        today_games_df_us = pandas.pandas.read_csv(matchup_output_us)
        today_games_df_us['Date'] = pandas.to_datetime(today_games_df_us['Date'], format='%Y-%m-%d')
        ...
        sibyl_metrics_df.to_csv('Sibyl_metrics_NBA.csv', mode='w+', index=True)
        month_teams_df.to_csv('Month_teams_NBA.csv', mode='w+', index=True)
        today_games_divstrat_df.to_csv('today_games_divstrat_NBA.csv', mode='w+', index=True)
